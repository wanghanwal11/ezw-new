    ...
    <div>
      <div class="header" style="height: 71px">
        ...
        <x-header style="background: #2989ff;position: fixed;width: 100%;z-index: 99;top: 15px;height: 55px">
          ...
          <div style="color: white;line-height: 55px;">写周报</div>
        ...
        methods: {
          ...
          tijiao(){
            ...
            for(let value of this.items){
              bzjh.push(value.textlist[0].value)
              bzwc.push(value.textlist[1].value)
            ...
            this.$ajax("rizhitijiao",{
              ...
              content :{
                ...
                bzwc:bzwc,
                wwc:wwc,
                gzzj:this.items2[0].textlist[0].value,
                fxts:this.items2[0].textlist[1].value,
                xtsx:this.items2[0].textlist[2].value,
                xzjh:this.items2[0].textlist[3].value
              },
              type:'week',
              issave:'1',
              filesid:arr.join(',')
